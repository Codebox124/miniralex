...
function Hero() {
  return (
    <div className='w-full h-[75vh] roadmaphero flex flex-col items-end'>
        ...
        <div className='mt-[13%]  w-[95%]'>
            ...
            className='flex flex-col md:flex-row md:items-center text-md md:text-xl'>HOME <MdKeyboardArrowRight className='text-[#F8D835]' />PROVIDE A CLEAR TIMELINE OF MILESTONES AND FUTURE PLANS</motion.p>
            <motion.h1 
              initial={frombotttomtotop.initial}
              animate={frombotttomtotop.animate}
              transition={frombotttomtotop.transition}
              viewport={frombotttomtotop.viewport}
            className='text-[#F8D835] text-3xl md:text-5xl font-bold mt-[20px]'>ROADMAP</motion.h1>
        </div>
    </div>
  )
}

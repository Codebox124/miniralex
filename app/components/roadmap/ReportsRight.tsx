...
function ReportsRight() {
  return (
    <div className='text-black p-[30px] w-full md:w-[70%]'>
        ...
        className='text-[#F8D835] text-4xl font-bold'>REPORTS & VALIDATION</motion.h1>
        <div className='reportsgrid w-full mt-[30px]'>
            <motion.div
             initial={frombotttomtotop.initial}
                    ...
                    viewport={frombotttomtotop.viewport}
            >
                <img src="/leading.png"  alt="leading" className='mb-[15px] w-full md:w-[fit-content]'  />
                <p className='mb-[15px]'>LEADING AUDITING FIRMS</p>
                <p className='flex items-center font-bold text-[#817C7C] justify-between md:justify-none'>PDF 15.44MB <RiDownloadLine className='md:ml-[30%]' /></p>
            </motion.div>
            <motion.div
             initial={frombotttomtotop.initial}
                    whileInView={frombotttomtotop.whileInView}
                    ...
                    viewport={frombotttomtotop.viewport}
            >
                <img src="/including.png" alt="leading" className='mb-[15px] w-full md:w-[fit-content]' />
            ...
            <motion.div
             initial={frombotttomtotop.initial}
                    ...
                    viewport={frombotttomtotop.viewport}
            >
                <img src="/documentation.png" alt="leading" className='mb-[15px] w-full md:w-[fit-content]' />

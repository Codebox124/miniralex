...
function Hero() {
  ...
  return (
    <div className='w-full h-[75vh] presalehero flex flex-col items-end text-white'>
        ...
        <div className='mt-[13%]  w-[95%]'>
            ...
            className='flex flex-col md:flex-row md:items-center text-md md:text-xl'>HOME <MdKeyboardArrowRight className='text-[#F8D835]' />GET TOKEN IN ADVANCE</motion.p>
            <motion.h1 
              initial={frombotttomtotop.initial}
              animate={frombotttomtotop.animate}
              transition={frombotttomtotop.transition}
              viewport={frombotttomtotop.viewport}
            className='text-[#F8D835] text-3xl md:text-5xl font-bold mt-[20px]'>PRESALE TOKEN</motion.h1>
        </div>
    </div>
  )
}
